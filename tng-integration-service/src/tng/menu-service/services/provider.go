...
func InitialServices() *dig.Container {
	...
	_ = serviceContainer.Provide(NewCategoryService)
	_ = serviceContainer.Provide(repositories.NewCategoryRepository)
	_ = serviceContainer.Provide(repositories.NewAreaRepository)
	_ = serviceContainer.Provide(NewAreaService)
	_ = serviceContainer.Provide(repositories.NewItemTypeRepository)
	_ = serviceContainer.Provide(NewItemTypeService)
