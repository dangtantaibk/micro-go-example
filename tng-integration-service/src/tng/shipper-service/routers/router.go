...
import (
	...
	"tng/shipper-service/controllers"
...
func init() {
	...
	ns := beego.NewNamespace("/vpos/api/v1",
		...
		beego.NSNamespace("/shipper",
			beego.NSInclude(&controllers.ShipperController{}),
		),
	)
...
func initialDB() {
	...
	orm.RegisterModel(new(models_shiper.Invoice))
	orm.RegisterModel(new(models_shiper.InvoiceDetail))
	orm.RegisterModel(new(models_shiper.User))
	orm.RegisterModel(new(models_shiper.Shipper))
	orm.RegisterModel(new(models_shiper.General))
	orm.RegisterModel(new(models_shiper.Item))
}
