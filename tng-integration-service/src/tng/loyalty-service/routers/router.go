...
import (
	...
	"tng/loyalty-service/controllers"
...
func init() {
	...
	ns := beego.NewNamespace("/tng/api/v1",
		beego.NSNamespace("/setting",
			beego.NSInclude(&controllers.SettingController{}),
		),
		beego.NSNamespace("/class-tracking",
			beego.NSInclude(&controllers.ClassTrackingController{}),
		),
		beego.NSNamespace("/point-class",
			beego.NSInclude(&controllers.PointClassController{}),
		),
		beego.NSNamespace("/point-type",
			beego.NSInclude(&controllers.PointTypeController{}),
		),
		beego.NSNamespace("/wallet",
			beego.NSInclude(&controllers.WalletController{}),
		),
		beego.NSNamespace("/point",
			beego.NSInclude(&controllers.PointController{}),
		),
	)
...
func initialDB() {
	...
	orm.RegisterModel(new(loyalty.Setting))
	orm.RegisterModel(new(loyalty.ClassTracking))
	orm.RegisterModel(new(loyalty.Point))
	orm.RegisterModel(new(loyalty.PointClass))
	orm.RegisterModel(new(loyalty.PointType))
	orm.RegisterModel(new(loyalty.Wallet))
}
